"""100 adimlik sahte bir gunu simule eder ve yedi hormonu metin tablo olarak basar.
...
def gunu_kos():
    ...
    for adim in range(1, ADIM_SAYISI + 1):
        # Planda olay yoksa Minik calismaya devam ediyor: bos adim yorgunluk biriktirir.
        # Adim basina TEK guncelle cagrilir, yoksa sonumleme iki kez isler ve gun kisalir.
        olay, siddet = plan.get(adim, ("calisma", 1.0))
