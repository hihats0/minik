#!/bin/bash
# Sabah zinciri (25 Eyl 05:05, gece zinciri 02:28'de 91 C ile kesildi): sohbet 1000'e tamamlanir, tohum v0
...
python -m cocuk.sohbet_uret --sohbet 1000 >> "$LOG" 2>&1; yaz "sohbet 1000 bitti: $? ($(wc -l < cocuk/veri/sohbet.jsonl) sohbet)"
izi_var
