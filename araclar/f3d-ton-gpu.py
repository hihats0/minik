...
Cagiran: elle, `python araclar/f3d-ton-gpu.py <model.gguf>`. Sunucuyu kendisi baslatir ve durdurur.
"""
...
from sunucu_yonet import LLAMA_SERVER, LOG_KLASORU, durdur, hazir_bekle, ram_zirve_mb
