...
Cagiran: elle, `.venv\\Scripts\\python.exe araclar\\f3c3-kor-uretim.py`."""
...
_OZELLIK = importlib.util.spec_from_file_location("f3c1", KOK / "araclar" / "f3c1-kor-uretim.py")
f3c1 = importlib.util.module_from_spec(_OZELLIK)
_OZELLIK.loader.exec_module(f3c1)
f3c1.SUNUCU_LOG = KOK / "araclar" / "sunucu-loglari" / "f3c3-sunucu.log"
