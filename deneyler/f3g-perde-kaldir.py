...
Cagiran: elle, `python deneyler\\f3g-perde-kaldir.py`; tests/test_f3g_perde.py. f3c3 aracinin bolumlerini kullanir.
...
_OZ = importlib.util.spec_from_file_location("f3c3_perde", KOK / "deneyler" / "f3c3-perde-kaldir.py")
