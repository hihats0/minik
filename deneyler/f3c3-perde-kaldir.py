...
Cagiran: elle, `python deneyler\\f3c3-perde-kaldir.py`; tests/test_f3c3_perde.py.
"""
...
_OZ = importlib.util.spec_from_file_location("f3c2", KOK / "deneyler" / "f3c2-perde-kaldir.py")
