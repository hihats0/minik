...
ayiklama) tekrarlar; kaldigi yerden devam eder, 90 dk'da "yarim" cikar. Cagiran: deneyler/f3g-uretim-baslat.ps1."""
...
from ortak import sunucu as sunucu_yonet  # noqa: E402
...
def _yukle(ad, dosya):
    ...
    ozellik = importlib.util.spec_from_file_location(ad, KOK / "deneyler" / dosya)
