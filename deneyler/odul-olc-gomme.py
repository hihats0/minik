...
Cagiran: elle, `python deneyler/odul-olc-gomme.py <model.gguf> <ad> [on_ek]`. Sunucuyu kendisi baslatir ve durdurur.
"""
...
from yuvalar.ton_kural import sinifla as kural_sinifla
